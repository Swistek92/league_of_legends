...
const page = async ({ params }: { params: { id: string } }) => {
  ...
  return (
     <div className='bg-blue-100 p-6 rounded-lg shadow-lg'>
      ...
      <p className='text-xl text-blue-600 mb-4'>{chempionsData.title}</p>
      <img
      ...
      />
      <p className='text-blue-800 text-lg my-4'>{chempionsData.lore}</p>
      ...
      <h2 className='text-2xl font-semibold text-blue-700 my-4'>Enemy Tips</h2>
      <ul className='list-disc list-inside text-blue-800'>
      ...
      <p className='text-blue-800'>Attack: {chempionsData.info.attack}</p>
      <p className='text-blue-800'>Defense: {chempionsData.info.defense}</p>
      <p className='text-blue-800'>Magic: {chempionsData.info.magic}</p>
      ...
      {chempionsData.spells.map((spell) => (
        <div key={spell.id} className='mb-4'>
          <h3 className='text-xl font-semibold text-blue-700'>{spell.name}</h3>
          <p className='text-blue-800'>{spell.description}</p>
          <p className='text-blue-800'>Cooldown: {spell.cooldownBurn}</p>
          <p className='text-blue-800'>Cost: {spell.costBurn}</p>
        </div>
      ))}
    </div>
